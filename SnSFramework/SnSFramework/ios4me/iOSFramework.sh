...
# Modified by Johan Attali for compliance with other projects
...
# Define these to suit your nefarious purposes
              ...
              FRAMEWORK_VERSION=A
       	     ...
       	     PROJECT_FILES_PATH=${PROJECT_DIR}/${PROJECT}
...
find ${PROJECT_FILES_PATH}/Classes -name "*.h" -exec cp {} $FRAMEWORK_DIR/Headers/ \; -print
...
cp ${PROJECT_FILES_PATH}/${PROJECT}.plist $FRAMEWORK_DIR/Resources/Info.plist
